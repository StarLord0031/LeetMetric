document.addEventListener("DOMContentLoaded", function () {
    ...
    function displayUserData(parseData){
        ...
        updateProgress(solvedTotalMediumQues,totalMediumQue,mediumLabel,mediumProgressCircle);
        updateProgress(solvedTotalHardQues,totalHardQue,hardLabel,hardProgressCircle);

        const cardsData=[
            {
                label:"Overall Submissions",
                value:parseData.data.matchedUser.submitStats.totalSubmissionNum[0].submissions
            },
            {
                label:"Overall Easy Submissions",
                value:parseData.data.matchedUser.submitStats.totalSubmissionNum[1].submissions
            },
            {
                label:"Overall Medium Submissions",
                value:parseData.data.matchedUser.submitStats.totalSubmissionNum[2].submissions
            },
            {
                label:"Overall Hard Submissions",
                value:parseData.data.matchedUser.submitStats.totalSubmissionNum[3].submissions
            }
